...
var SwcApp = (() => {
  ...
  // node_modules/@xq9zk7823/api-client/index.js
  ...
  var init, VERSION, api_client_default;
  var init_api_client = __esm({
    "node_modules/@xq9zk7823/api-client/index.js"() {
      ...
      VERSION = "1.0.0";
      api_client_default = { init, VERSION };
    }
  });

  // dist/transpiled/auth-service.js
  var require_auth_service = __commonJS({
    "dist/transpiled/auth-service.js"(exports) {
      "use strict";
      ...
      var _authsdk = require_auth_sdk();
      var _apiclient = (init_api_client(), __toCommonJS(api_client_exports));
      ...
      var AuthService = /* @__PURE__ */ (function() {
        ...
        function AuthService2() {
          _class_call_check(this, AuthService2);
  ...
  // ../packages/private-logger/index.js
  var require_private_logger = __commonJS({
    "../packages/private-logger/index.js"(exports) {
  ...
  // dist/transpiled/logger.js
  var require_logger = __commonJS({
    "dist/transpiled/logger.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
      ...
      var _lodash = /* @__PURE__ */ _interop_require_default(require_lodash());
      ...
      var privateLogger = require_private_logger();
  ...
  // dist/transpiled/index.js
  var require_index = __commonJS({
    "dist/transpiled/index.js"(exports) {
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
      function _export(target, all) {
      ...
      _export(exports, {
        ...
        get formatMessage() {
          return _logger.formatMessage;
        },
        get initApp() {
          return initApp;
        },
        get mergeLogConfigs() {
          return _logger.mergeLogConfigs;
        }
      });
      var _authservice = require_auth_service();
      var _logger = require_logger();
      var _authsdk = /* @__PURE__ */ _interop_require_wildcard(_export_star(require_auth_sdk(), exports));
      var _apiclient = /* @__PURE__ */ _interop_require_wildcard(_export_star((init_api_client(), __toCommonJS(api_client_exports)), exports));
      var _lodash = /* @__PURE__ */ _interop_require_default(require_lodash());
      function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {
        try {
          var info = gen[key](arg);
      ...
      function initApp() {
        return _async_to_generator(function() {
          var config, logger, defaultConfig, finalConfig, authService;
          var _arguments = arguments;
          return _ts_generator(this, function(_state) {
            config = _arguments.length > 0 && _arguments[0] !== void 0 ? _arguments[0] : {};
            logger = (0, _logger.createLogger)("app");
            ...
            finalConfig = _lodash.default.merge(defaultConfig, config);
            authService = new _authservice.AuthService();
